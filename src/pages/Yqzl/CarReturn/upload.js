...
function view(props) {
            ...
            <Space>
              <a
                onClick={() => {
                  ...
                  props.history.push(`/carReturnType/detail/${record.batchno}`);
                }}
              >
                查看
              </a>
  ...
  return (
    <Spin spinning={loading}>
      ...
      <CCStoreTable
        tableKey={'/carReturnType/upload'}
        rowKey={'batchno'}
        columns={columns}
        fetchFunc={(data, paging) => httpCommonClient.submit('/CarDataUploadAction_list', { fileType: '3', ...paging })}
        ref={tableRef}
      />
    </Spin>
  );
